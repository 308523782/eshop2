...
import com.eshop.service.AreaService;
import com.eshop.service.CartService;
import com.eshop.service.CouponCodeService;
...
import com.eshop.service.ShippingService;
...
public class OrderController extends BaseController {
	...
	public String info(ModelMap model) {
		...
		Orders order = orderService.build(cart, null, null, null, null, false, null, false, null);
	...
	Map<String, Object> calculate(Long paymentMethodId, Long shippingMethodId, String code, @RequestParam(defaultValue = "false") Boolean isInvoice, String invoiceTitle, @RequestParam(defaultValue = "false") Boolean useBalance, String memo) {
		...
		CouponCode couponCode = couponCodeService.findByCode(code);
		Orders order = orderService.build(cart, null, paymentMethod, shippingMethod, couponCode, isInvoice, invoiceTitle, useBalance, memo);
	...
	Message create(String cartToken, Long receiverId, Long paymentMethodId, Long shippingMethodId, String code, @RequestParam(defaultValue = "false") Boolean isInvoice, String invoiceTitle, @RequestParam(defaultValue = "false") Boolean useBalance, String memo) {
		...
		CouponCode couponCode = couponCodeService.findByCode(code);
		Orders order = orderService.create(cart, receiver, paymentMethod, shippingMethod, couponCode, isInvoice, invoiceTitle, useBalance, memo, null);
