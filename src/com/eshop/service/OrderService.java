...
public interface OrderService extends BaseService<Orders, Long> {
	 ...
	 * @return 订单
	 */
	Orders build(Cart cart, Receiver receiver, PaymentMethod paymentMethod, ShippingMethod shippingMethod, CouponCode couponCode, boolean isInvoice, String invoiceTitle, boolean useBalance, String memo);
	 ...
	 * @return 订单
	 */
	Orders create(Cart cart, Receiver receiver, PaymentMethod paymentMethod, ShippingMethod shippingMethod, CouponCode couponCode, boolean isInvoice, String invoiceTitle, boolean useBalance, String memo, Admin operator);
	 ...
	 *            操作员
	 */
	void update(Orders order, Admin operator);
	 ...
	 *            操作员
	 */
	void confirm(Orders order, Admin operator);
	 ...
	 *            操作员
	 */
	void complete(Orders order, Admin operator);
	 ...
	 *            操作员
	 */
	void cancel(Orders order, Admin operator);
	 ...
	 *            操作员
	 */
	void payment(Orders order, Payment payment, Admin operator);
	 ...
	 *            操作员
	 */
	void refunds(Orders order, Refunds refunds, Admin operator);
	 ...
	 *            操作员
	 */
	void shipping(Orders order, Shipping shipping, Admin operator);
	 ...
	 *            操作员
	 */
	void returns(Orders order, Returns returns, Admin operator);
